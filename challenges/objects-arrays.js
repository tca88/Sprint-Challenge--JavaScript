...
console.log(uni); // Universities that contin "Uni"
console.log(uni.length); // Total number of those Universities console logged above. 
...
zooAnimals.forEach((animal) => {
  ...
  Object.keys(animal).forEach((k) => {
    ...
    if(k === "scientific_name") {
      obj.Scientific = animal[k];
    }
  });
  animalNames.push(obj);
});
